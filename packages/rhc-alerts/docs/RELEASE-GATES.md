...
| ---------------------------- | -------------------------------------------------------------------- | ------------------------------------------------ |
| Exact source                 | Full Git SHA, clean tracked worktree                                 | **Pending: repository has no HEAD**              |
...
| LWC                          | 11 tests and thresholds 90/80/90/90                                  | Passed locally; must be tied to the release SHA  |
...
| Namespaced source behavior   | Dry-run deployment, 40 Apex tests, coverage, events, permissions     | **Pending; requires explicit org authorization** |
| No-namespace source behavior | Same source/test/runtime matrix in a no-namespace org                | **Pending; requires explicit org authorization** |
